    ...
    <header className={cx("header")}>
      ...
      <div className={cx("right")}>
        ...
        <div className={cx("profile")}>
          <img
            src="https://ui-avatars.com/api/?name=Admin&background=8c52ff&color=fff"
            alt="Admin"
            className={cx("avatar")}
          />
          <div className={cx("info")}>
            <span className={cx("name")}>Admin</span>
        ...
        <button className={cx("dark-mode-toggle")} onClick={toggleDarkMode}>
          {darkMode ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
